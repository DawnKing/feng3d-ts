...
(function (me) {
    ...
    (function (feng3d) {
        ...
        var Context3DBuffer = (function (_super) {
             ...
             * 映射属性缓冲
             */
            Context3DBuffer.prototype.mapAttributeBuffer = function (name, value, stride) {
             ...
             */
            Context3DBuffer.prototype.mapProgramBuffer = function (vertexCode, fragmentCode) {
...
(function (me) {
    ...
    (function (feng3d) {
        ...
        var IndexBuffer = (function (_super) {
             ...
             * 处理获取索引缓冲事件
             */
            IndexBuffer.prototype.onGetIndexBuffer = function (event) {
                var eventData = event.data;
                eventData.buffer = this;
            };
            return IndexBuffer;
    ...
    (function (feng3d) {
        ...
        var Object3DBuffer = (function () {
            ...
            Object3DBuffer.prototype.activeAttributes = function () {
                var attribLocations = this.programBuffer.getAttribLocations(this.context3D);
             ...
             * 准备顶点缓冲列表
             */
            Object3DBuffer.prototype.prepareAttributeBuffers = function (attribLocations) {
                for (var name in attribLocations) {
                    //从Object3D中获取顶点缓冲
...
(function (me) {
    ...
    (function (feng3d) {
        ...
        var ProgramBuffer = (function (_super) {
             ...
             * 处理获取缓冲事件
             */
            ProgramBuffer.prototype.onGetProgramBuffer = function (event) {
                var eventData = event.data;
                eventData.buffer = this;
            };
...
(function (me) {
    ...
    (function (feng3d) {
        ...
        var Material = (function (_super) {
            ...
            Object.defineProperty(Material.prototype, "context3DBuffer", {
                /**
                 * Context3D数据缓冲
                 */
                get: function () {
