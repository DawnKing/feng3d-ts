module feng3d
{
	...
	export class TextureCenter
	{
		...
		{
			var texture:CubeTexture = context3D["TextureCenter.createCubeTexture"](bitmapTexture.size, bitmapTexture.format, bitmapTexture.optimizeForRenderToTexture, bitmapTexture.streamingLevels);
