module feng3dRE {
    ...
    export class FagalRegisterCenter extends Proxy {
        ...
        public static get dataRegisterDic() {
            if (FagalRegisterCenter._dataRegisterDic == null)
                FagalRegisterCenter._dataRegisterDic = {};
            return FagalRegisterCenter._dataRegisterDic;
        }
        ...
        public getProperty(name) {
            ...
            var idData: any[] = FagalRE.idDic[attr];
            //获取寄存器
